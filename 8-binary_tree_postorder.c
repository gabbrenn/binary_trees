 ...
 * which means it processes the left subtree, then the right subtree, and finally
 * the current node. It recursively applies the specified function to each node
